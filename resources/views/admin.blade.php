        ...
        <div class="main-content">
            ...
            <div class="employee-list">
                <div class="employee-list-header">
                    <h2>EMPLOYEE LIST</h2> <!-- Title on the left -->
                    <div class="buttons">
                        <button class="icon-button">
                            <i class="fas fa-pending"></i> <!-- Task icon -->
                            PENDING
                        </button>
                        <button class="icon-button">
                            <i class="fas fa-ticket-search"></i> <!-- Ticket icon -->
                            SEARCH
                        </button>
                        <button class="icon-button">
                            <i class="fas fa-check-export"></i> <!-- Monitoring icon -->
                            EXPORT
                        </button>
                    </div>
                </div>
                ...
                <div class="employee-container">
                    <div class="employee-photo">
                        <img src="data:image/jpeg;base64,{{ base64_encode($employee->ProfilePicture) }}" alt="Profile Picture">
                    </div>
                    <div class="employee-info">
                        <h3>{{ $employee->FirstName }} {{ $employee->LastName }}</h3>
                        <p>ID: {{ $employee->EmployeeID }}</p>
                        <p>Account Type: {{ $employee->AccountType }}</p>
